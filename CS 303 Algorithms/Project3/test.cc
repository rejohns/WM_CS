...
int main(int argc, char** argv) {
	...
	GroupOfNumbers digits11(10);
	for (int i = 10; i > 0; i--) {
		digits11.add(i);
	}
	digits11.partial_max_heap_select(5, b);
	cout << b << endl;
	digits11.sort_select(5, b);
	cout << b << endl;
	digits11.partial_sort_select(5, b);
	cout << b << endl;
	digits11.quick_select(5, b);
	cout << b << endl;
	digits11.min_heap_select(5, b);
	cout << b << endl;
	return 0;
}