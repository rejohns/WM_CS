...
class GroupOfNumbers {
 ...
 protected:
  ...
  //protected method for linear_select
  long median_of_median_of_5(long *tempArr, long left, long right) const;
  ...
  // protected methods for selection algorithms:
  long select_element(long k) const;
  // selects kth element from _group, used for temp_group

  void set_element(long pos, long k);
  // switches pos element with k, used for temp_group
  
  void quick_select(long left, long right, long k);
  // protected quick_select method, for recursive purposes

  void linear_select(long *temp_group, long left, long right, long k) const;
  // protected linear_select method, for recursive purposes

  void percolateDown2(long hole, long currentSize) const;
  // alternate percolate_down method, for min_heap_select
  // end protected selection methods
