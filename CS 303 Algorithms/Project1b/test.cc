...
int main(int argc, char** argv) {
	...
	cout << "" << endl;
	cout << "NOW TESTING PROJECT 1b" << endl;
	cout << "" << endl;

	GroupOfNumbers digits4(0, 9, 55);
	digits4.displayGroupOfNumbers();
	digits4.writeGroupOfNumbersTo("mahfile.txt");

	cout << "" << endl;

	cout << "NOW TESTING SECOND NEW CONSTRUCTOR" << endl;
	long a = 4;	
	GroupOfNumbers digits5("mahfile.txt", a);
